...
data = pd.read_csv("CRR_times_fidelity_1e-06.csv")
data2 = pd.read_csv("CRR_times_fidelity_1e-07.csv")
data3 = pd.read_csv("CRR_times_fidelity_1e-08.csv")
...
plt.plot(x, episode_reward2, marker='^', markevery=150, color='c', linestyle='-.', markerfacecolor='none', label='$\mathcal{F}^{thr}=le-7$')
