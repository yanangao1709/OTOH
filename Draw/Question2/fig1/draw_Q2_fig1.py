...
data = pd.read_csv("delay_thr-120.csv")
data2 = pd.read_csv("delay_thr-150.csv")
...
plt.plot(xx, episode_reward2, marker='^', markevery=150, color='c', linestyle='-.', markerfacecolor='none', label='$\Gamma^{thr}=150$')
