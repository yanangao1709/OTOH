...
class RewardDecomposer:
    ...
    def convert_raw_outputs(self, raw_outputs, output_type=AGENT_REWARDS):
        ...
        converted_outputs_normal = nn.functional.normalize(converted_outputs, dim=2)
        return converted_outputs_normal
    ...
    def get_all_combinations(self, filter_combos=True):
        ...
        # reward_combos_classes = []
        # prc = product(*reward_classes)
        # for rc in prc:
        #     reward_combos_classes.append(rc)
